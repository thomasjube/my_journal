                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post">
			                                <div class="form-group">
			                                    ...
			                                    <input class="au-input au-input--full" type="date" name="beginDate" id="birthDateInput">
			                                </div>
			                                <div class="form-group">
			                                    <label>Date de fin</label>
			                                    <input class="au-input au-input--full" type="date" name="endDate" id="birthDateInput">
			                                </div>
