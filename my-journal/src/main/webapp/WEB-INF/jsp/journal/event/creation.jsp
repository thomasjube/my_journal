                                        ...
                                        <form action="" method="post">
	                                        ...
	                                        <input class="au-input au-input--full" type="hidden" name="journalEventUuid" value="${form.journalEventUuid}">
				                                <div class="form-group">
				                                    <label>Date</label>
				                                    <input class="au-input au-input--full" type="date" name="date">
				                                </div>
				                                <div class="form-group">
				                                    <label>Heure</label>
				                                    <input class="au-input au-input--full" type="time" name="time">
				                                </div>
				                                <div class="form-group">
				                                ...
				                                <div class="form-group">
				                                    <label>Lieu</label>
				                                    <input class="au-input au-input--full" type="text" name="place">
				                                </div>
				                                <div class="form-group">
				                                    <label>Commentaires</label>
				                                    <input class="au-input au-input--full" type="text" name="comments">
				                                </div>
