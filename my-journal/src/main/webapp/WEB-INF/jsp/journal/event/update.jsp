                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Nouvel évenement</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" method="post">
	                                        <input class="au-input au-input--full" type="hidden" name="journalUuid" value="${form.journalUuid}">
	                                        <input class="au-input au-input--full" type="hidden" name="journalEventUuid" value="${form.journalEventUuid}">
				                                <div class="form-group">
				                                    <label>Date</label>
				                                    <input class="au-input au-input--full" type="date" name="date" value="${form.date}">
				                                </div>
				                                <div class="form-group">
				                                    <label>Heure</label>
				                                    <input class="au-input au-input--full" type="time" name="time" value="${form.time}">
				                                </div>
				                                <div class="form-group">
				                                ...
				                                <div class="form-group">
				                                    <label>Lieu</label>
				                                    <input class="au-input au-input--full" type="text" name="place" value="${form.place}">
				                                </div>
				                                <div class="form-group">
				                                    <label>Commentaires</label>
				                                    <input class="au-input au-input--full" type="text" name="comments" value="${form.comments}">
				                                </div>
