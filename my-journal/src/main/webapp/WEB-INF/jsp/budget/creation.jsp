                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" class="form-horizontal">
                                            ...
                                            <input type="hidden" name="budgetUuid">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Nom</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" name="description" placeholder="Budget" class="form-control"/>
                                                    <small class="form-text text-muted">Entrer le nom du budget</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Montant du budget</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                   <input type="text" name="budgetTotal" placeholder="Budget" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <select name="categoryTaskUuid" required="required" class="form-control">
                                                    <option value="">Please select</option>
                                                    <c:forEach items="${categoryTasks}" var="categoryTask">
														<option value="${categoryTask.uuid}">${categoryTask.description}</option>                                                    	
                                                    </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
